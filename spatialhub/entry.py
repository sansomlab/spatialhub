'''
spatialhub.py - single cell data warehousing and analysis pipelines
================================================================
...
To use a specific workflow, type::
    ...
    spatialhub <workflow> [workflow options] [workflow arguments]
...
def main(argv=None):
    ...
    if argv[2] == "profile":
        ...
        import spatialhub.tasks.profile as p
        
        p.profile(pipeline + ".log", show_fields=False)
        
        return

    # remove 'spatialhub' from sys.argv
    del sys.argv[0]
