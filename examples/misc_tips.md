...
**Much of the code described here is (or will soon be) available as utils function in R and/or Python, as described in these scripts: [`R/_clean-up_utils.R`](../R/_clean-up_utils.R) and/or [`spatialhub/tasks/adata_utils.py`](../spatialhub/tasks/adata_utils.py)**
